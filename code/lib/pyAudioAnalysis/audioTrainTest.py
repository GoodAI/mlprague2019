...
import csv
import ntpath
from code.lib.pyAudioAnalysis import audioFeatureExtraction as aF
...
def featureAndTrain(list_of_dirs, mt_win, mt_step, st_win, st_step, 
    ...
    trainWithFeatures(features, classNames, mt_win, mt_step, st_win, st_step, classifier_type, model_name, compute_beat, perTrain)


def featureWavAndTrain(list_of_lists_of_wavs, sampling_rate, list_of_classes, mt_win, mt_step, st_win, st_step, 
                       classifier_type, model_name, compute_beat=False, perTrain=0.90):
    '''
    Extract features from a wave file loaded into memory
    '''
    features = aF.listsWavFeatureExtraction(list_of_lists_of_wavs, 
                                            sampling_rate,
                                            mt_win, 
                                            mt_step, 
                                            st_win, 
    ...
    trainWithFeatures(features, list_of_classes, mt_win, mt_step, st_win, st_step, classifier_type, model_name, compute_beat, perTrain)


def trainWithFeatures(features, classNames, mt_win, mt_step, st_win, st_step, 
                      classifier_type, model_name, compute_beat, perTrain):
    if len(features) == 0:
